...
class Uploader {
    ...
    uploadBundle(transactions, opts) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield tx.sign(this.currencyConfig.getSigner());
