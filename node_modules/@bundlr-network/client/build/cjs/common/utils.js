...
class Utils {
    ...
    getNonce() {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield this.api.get(`/account/withdrawals/${this.currencyConfig.name}?address=${this.currencyConfig.address}`);
    ...
    getBalance(address) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield this.api.get(`/account/balance/${this.currencyConfig.name}?address=${address}`);
    ...
    estimateFolderPrice(folderInfo) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const headerSizeAvg = (_a = folderInfo.headerSizeAvg) !== null && _a !== void 0 ? _a : this.arbundles.createData("", this.currencyConfig.getSigner()).getRaw().length;
            const pricePerTxBase = yield this.getPrice(this.currencyConfig.name, headerSizeAvg);
            const basePriceForTxs = pricePerTxBase.multipliedBy(folderInfo.fileCount);
            const priceForData = (yield this.getPrice(this.currencyConfig.name, folderInfo.totalBytes)).plus(basePriceForTxs).decimalPlaces(0);
            return priceForData;
        });
    }
    /**
    ...
    toAtomic(decimalAmount) {
        return new bignumber_js_1.default(decimalAmount).multipliedBy(this.currencyConfig.base[1]);
    }
    /**
    ...
    fromAtomic(atomicAmount) {
        return new bignumber_js_1.default(atomicAmount).dividedBy(this.currencyConfig.base[1]);
    }
    /**
    ...
    confirmationPoll(txid, seconds = 30) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const internalPoll = () => __awaiter(this, void 0, void 0, function* () {
                while (!timedout) {
                    const getRes = yield this.currencyConfig
                        .getTx(txid)
