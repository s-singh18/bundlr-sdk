...
class NodeUploader extends upload_1.default {
    ...
    uploadFolder(path, { batchSize = 10, keepDeleted = true, indexFile, interactivePreflight, logFunction, manifestTags, } = { batchSize: 10, keepDeleted: true }) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (interactivePreflight) {
                if (!(yield confirmation(`Authorize upload?\nTotal amount of data: ${total} bytes over ${files.length} files - cost: ${price} ${this.currencyConfig.base[0]} (${this.utils.fromAtomic(price).toFixed()} ${this.currency})\n Y / N`))) {
            ...
            const processor = (data) => __awaiter(this, void 0, void 0, function* () {
                ...
                if ((_l = data === null || data === void 0 ? void 0 : data.res) === null || _l === void 0 ? void 0 : _l.id) {
                    stringifier.write([(0, path_1.relative)(path, data.item), data.res.id]);
                }
            });
            const processingResults = yield this.concurrentUploader(files, batchSize, processor, logFunction);
